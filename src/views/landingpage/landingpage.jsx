      ...
      <section class="lg:flex items-center w-screen bg-gray-900 relative">
        <div class="w-auto flex-col ">
          <h2 class="text-3xl mt-8 mb-6 lg:pl-5  text-gray-300">
            Effortlessly manage and track your expenses with our powerful
            Expense Tracker. Gain insights, save money, and achieve financial
            freedom.
          </h2>
          <a href="login.jsp" class="btn rounded-lg btn-teal">
            Get Started
          </a>
        </div>
        <div class="w-full relative images">
          <img
            src="src/assets/svg_2.svg"
        ...
        <div class="flex-wrap items-center justify-center gap-8 text-center sm:flex">
          <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
            ...
            <p class="py-4 text-gray-500 text-md dark:text-gray-300">
              Expense Tracker helps you efficiently manage your finances,
              providing insights into your spending habits and budget planning.
            </p>
          </div>
          <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 sm:mt-16 md:mt-20 lg:mt-24 dark:bg-gray-800">
            ...
            <p class="py-4 text-gray-500 text-md dark:text-gray-300">
              Expense Tracker allows you to track your spending, set budget
              goals, receive financial insights, and achieve financial
              stability.
            </p>
          </div>
          <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
            ...
            <p class="py-4 text-gray-500 text-md dark:text-gray-300">
              Expense Tracker is essential for maintaining a clear understanding
              of your financial health, avoiding overspending, and achieving
