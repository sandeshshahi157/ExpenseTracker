...
const WalletPage = () => {
  ...
  const handleCCVNumberChange = (event) => {
    const input = event.target.value.replace(/\D/g, "");
    setCCVNumber(input);
  };
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 lg:p-24">
      <form className="w-full max-w-3xl mx-auto px-4 lg:px-6 py-8 shadow-md rounded-md flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 lg:pr-8 lg:border-r-2 lg:border-slate-300">
          <div className="mb-4">
            <label className="dark:text-gray-300 font-bold text-sm mb-2 block">
              Card number:
            </label>
            <input
              id="cardNumber"
              ...
              className="flex h-10 w-full rounded-md border-2 bg-background text-gray-500 px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              maxLength="19"
          ...
          <div className="flex gap-x-2 mb-4">
            <div className="block">
              ...
              <input
                ...
                className="text-gray-500 flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                maxLength="5"
                placeholder="MM/YY"
                value={expDate}
              />
            ...
            <div className="block">
              <label className="text-neutral-800 dark:text-gray-300 font-bold text-sm mb-2 block">
                CCV:
              </label>
              <input
                id="ccvNumber"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="flex text-gray-500 h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              placeholder="Name"
              value={cardName}
            />
          </div>
